...
exports.getShortUrl =  (username, longUrl, callback) => {
...
// get emoji shortURL
exports.generateShortUrl = (callback) => {
    callback(convertToEmoji());
};

// randomly generate shortURL
exports.convertToEmoji = () => {
    do {
        var result = "";
        for (var x = 0; x < 6; x++) {
...
exports.getMyUrls = (username, callback) => {
